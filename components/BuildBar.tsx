...
import Cabin from "@/public/assets/buildings/house.png";
...
export default function BuildBar() {
  ...
  const [menu, setMenu] = useState<"root" | "buildings">("root");
